...
- Azure disk storage provisioner
...
MSSQL_PID:
  value: "Express"  # Or "Developer", "Standard", "Enterprise"
...
Uncomment the `fsGroup` setting in your values file:

```yaml
podSecurityContext:
  fsGroupChangePolicy: OnRootMismatch
  fsGroup: 10001  # Uncomment for AKS/Kubernetes
```

#### For OpenShift

Use the default configuration (fsGroup is automatically assigned by OpenShift):

```yaml
podSecurityContext:
  fsGroupChangePolicy: OnRootMismatch
  # fsGroup: 10001  # Keep commented for OpenShift
```
